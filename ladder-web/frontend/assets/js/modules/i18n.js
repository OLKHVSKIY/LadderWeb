...
const translations = {
    ru: {
        ...
        'tasks.tags': 'Хештеги',
        'tasks.tagsPlaceholder': 'Например: работа срочно (через пробел)',
        'tasks.tagsHint': 'Введите хештеги через пробел',
    ...
    en: {
        ...
        'tasks.tags': 'Hashtags',
        'tasks.tagsPlaceholder': 'For example: work urgent (space separated)',
        'tasks.tagsHint': 'Enter hashtags separated by spaces',
        'tasks.date': 'Date',
